...
const Config = function () {
  ...
  this.braveServicesKey = getNPMConfig(['brave_services_key']) || 'brave_services_key'
  ...
  this.braveZeroExApiKey = getNPMConfig(['brave_zero_ex_api_key']) || 'brave_zero_ex_api_key'
  this.sardineClientId = getNPMConfig(['sardine_client_id']) || 'brave_zero_ex_api_key'
  ...
  this.bitFlyerSandboxClientSecret = getNPMConfig(['bitflyer_sandbox_client_secret']) || 'bitflyer_production_client_id'
  this.bitFlyerSandboxFeeAddress = getNPMConfig(['bitflyer_sandbox_fee_address']) || 'bitflyer_production_client_id'
  this.bitFlyerSandboxUrl = getNPMConfig(['bitflyer_sandbox_url']) || 'bitflyer_production_client_id'
  this.geminiProductionApiUrl = getNPMConfig(['gemini_production_api_url']) || 'bitflyer_production_client_id'
  this.geminiProductionClientId = getNPMConfig(['gemini_production_client_id']) || 'bitflyer_production_client_id'
  this.geminiProductionClientSecret = getNPMConfig(['gemini_production_client_secret']) || 'bitflyer_production_client_id'
  this.geminiProductionFeeAddress = getNPMConfig(['gemini_production_fee_address']) || 'bitflyer_production_client_id'
  this.geminiProductionOauthUrl = getNPMConfig(['gemini_production_oauth_url']) || 'bitflyer_production_client_id'
  this.geminiSandboxApiUrl = getNPMConfig(['gemini_sandbox_api_url']) || 'bitflyer_production_client_id'
  this.geminiSandboxClientId = getNPMConfig(['gemini_sandbox_client_id']) || 'bitflyer_production_client_id'
  this.geminiSandboxClientSecret = getNPMConfig(['gemini_sandbox_client_secret']) || 'bitflyer_production_client_id'
  this.geminiSandboxFeeAddress = getNPMConfig(['gemini_sandbox_fee_address']) || 'bitflyer_production_client_id'
  this.geminiSandboxOauthUrl = getNPMConfig(['gemini_sandbox_oauth_url']) || 'bitflyer_production_client_id'
  this.upholdProductionApiUrl = getNPMConfig(['uphold_production_api_url']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.upholdProductionClientId = getNPMConfig(['uphold_production_client_id']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.upholdProductionClientSecret = getNPMConfig(['uphold_production_client_secret']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.upholdProductionFeeAddress = getNPMConfig(['uphold_production_fee_address']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.upholdProductionOauthUrl = getNPMConfig(['uphold_production_oauth_url']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.upholdSandboxApiUrl = getNPMConfig(['uphold_sandbox_api_url']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.upholdSandboxClientId = getNPMConfig(['uphold_sandbox_client_id']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.upholdSandboxClientSecret = getNPMConfig(['uphold_sandbox_client_secret']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.upholdSandboxFeeAddress = getNPMConfig(['uphold_sandbox_fee_address']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.upholdSandboxOauthUrl = getNPMConfig(['uphold_sandbox_oauth_url']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.zebPayProductionApiUrl = getNPMConfig(['zebpay_production_api_url']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.zebPayProductionClientId = getNPMConfig(['zebpay_production_client_id']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.zebPayProductionClientSecret = getNPMConfig(['zebpay_production_client_secret']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.zebPayProductionOauthUrl = getNPMConfig(['zebpay_production_oauth_url']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.zebPaySandboxApiUrl = getNPMConfig(['zebpay_sandbox_api_url']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.zebPaySandboxClientId = getNPMConfig(['zebpay_sandbox_client_id']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.zebPaySandboxClientSecret = getNPMConfig(['zebpay_sandbox_client_secret']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.zebPaySandboxOauthUrl = getNPMConfig(['zebpay_sandbox_oauth_url']) || 'BITFLYER_PRODUCTION_CLIENT_ID'
  this.braveSyncEndpoint = getNPMConfig(['brave_sync_endpoint']) || 'updater_dev_endpoint'
  this.safeBrowsingApiEndpoint = getNPMConfig(['safebrowsing_api_endpoint']) || 'updater_dev_endpointupdater_dev_endpoint'
  this.updaterProdEndpoint = getNPMConfig(['updater_prod_endpoint']) || 'updater_dev_endpoint'
  this.updaterDevEndpoint = getNPMConfig(['updater_dev_endpoint']) || 'updater_dev_endpoint'
  this.webcompatReportApiEndpoint = getNPMConfig(['webcompat_report_api_endpoint']) || 'https://webcompat.brave.com/1/webcompat'
  this.rewardsGrantDevEndpoint = getNPMConfig(['rewards_grant_dev_endpoint']) || 'updater_dev_endpoint'
  this.rewardsGrantStagingEndpoint = getNPMConfig(['rewards_grant_staging_endpoint']) || 'updater_dev_endpoint'
  this.rewardsGrantProdEndpoint = getNPMConfig(['rewards_grant_prod_endpoint']) || 'updater_dev_endpoint'
  ...
  this.braveStatsUpdaterUrl = getNPMConfig(['brave_stats_updater_url']) || 'brave_stats_updater_url'
  ...
  this.braveVariationsServerUrl = getNPMConfig(['brave_variations_server_url']) || 'brave_variations_server_url'
  ...
  this.brave_services_key_id = getNPMConfig(['brave_services_key_id']) || 'service_key_aichat'
  this.service_key_aichat = getNPMConfig(['service_key_aichat']) || 'service_key_aichat'
}
