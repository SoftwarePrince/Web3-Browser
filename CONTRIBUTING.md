...
BrowseWeb3 welcomes contributions of all kinds! You can make a huge impact without writing a single line of code
...
* Capturing/updating helpful information [in our wiki](https://github.com/brave/brave-browser/wiki). You'll need to reach out to a BrowseWeb3 team member to request permission - you can do this by creating a new issue or tagging a BrowseWeb3 team member in an existing issue.
...
All text being added to BrowseWeb3 is done initially in English (en-US) and then is translated by real people into other languages.
...
* Once you're up and running, find an interesting issue to fix. Check out issues labelled with [good first issue](https://github.com/brave/brave-browser/labels/good%20first%20issue)
  - some issues only require knowledge of JavaScript (for example, pages using React and our [BrowseWeb3 UI library](https://github.com/brave/brave-ui))
  - other issues may require C++ changes in either the BrowseWeb3 code or in Chromium

## Getting started
* Make sure you have a [GitHub account](https://github.com/join).
* Submit a [ticket](https://github.com/brave/brave-browser/issues) for your issue if one does not already exist. Please include the BrowseWeb3 version, operating system, and steps to reproduce the issue.
...
Once you submit a pull request, you should tag reviewers and add labels if needed. If you do not have the necessary GitHub permissions to do so, a BrowseWeb3 member will take care of this for you.
...
* You can be granted write permission if you've helped a lot with triage by pinging @bbondy, @bsclifton, @kjozwiak, or another BrowseWeb3 team member.
* Helping make sure issues have a clear and understandable name (ex: not something like "BrowseWeb3 is broken").
