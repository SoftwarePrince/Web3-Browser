...
constexpr char kBraveUrl[] = "https://browseweb3.com";
...
TEST_F(BraveWalletServiceUnitTest, MigrateUserAssetsAddPreloadingNetworks) {
      ...
      "0xfa": [
        {
          ...
          "is_erc20":true,
          "is_erc721":false,
          "logo":"https://browseweb3.com/logo.jpg",
          "name":"WTRTL",
          "symbol":"WTRTL",
          "token_id":"",
          "visible":true
  ...
  auto wtrtl = mojom::BlockchainToken::New(
      ...
      "https://browseweb3.com/logo.jpg", true, false, false, false, false, "WTRTL",
...
TEST_F(BraveWalletServiceUnitTest, SignMessageHardware) {
  ...
  mojom::OriginInfoPtr origin_info =
      MakeOriginInfo(url::Origin::Create(GURL("https://browseweb3.com")));
...
TEST_F(BraveWalletServiceUnitTest, GetSimpleHashSpamNFTs) {
  ...
  GURL url = GURL(
      "https://simplehash.wallet.browseweb3.com/api/v0/nfts/"
