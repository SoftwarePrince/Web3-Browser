...
#define BRAVE_MODULE_FILENAME_PATCH                                            \
  IF_BUILDFLAG(                                                                \
      ...
      EXPAND_FEATURE_ENTRIES({                                                 \
          ...
          "Enables patching of executable's name from browseweb3.exe to "           \
...
#define BRAVE_ABOUT_FLAGS_FEATURE_ENTRIES                                      \
  EXPAND_FEATURE_ENTRIES(                                                      \
      ...
      {                                                                        \
          ...
          "browseweb3://adblock hasn't otherwise been modified",                    \
          kOsAll,                                                              \
          FEATURE_VALUE_TYPE(                                                  \
      ...
      {                                                                        \
          ...
          "its toggle in browseweb3://adblock hasn't otherwise been modified",      \
          kOsAll,                                                              \
...
// Called to skip feature entries on browseweb3://flags page without affecting
// features state.
