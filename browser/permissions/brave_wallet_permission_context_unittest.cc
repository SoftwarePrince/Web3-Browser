...
TEST_F(BraveWalletPermissionContextUnitTest, AddPermission) {
  url::Origin origin = url::Origin::Create(GURL("https://www.browseweb3.com/"));
  const struct {
    const char* address;
...
TEST_F(BraveWalletPermissionContextUnitTest, GetWebSitesWithPermission) {
  ...
  for (auto entry : cases) {
    ...
    // "https://www.browseweb3.com__brg44hdsehzapvs8beqzvkq4egwevs3fre6ze2eno6s8/"
    // web_sites[0] looks like that
    // "https://www.browseweb3.com__brg44hdsehzapvs8beqzvkq4egwevs3fre6ze2eno6s8:443"
