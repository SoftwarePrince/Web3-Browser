...
TEST_F(SidebarModelTest, ItemsChangedTest) {
  ...
  SidebarItem new_item = SidebarItem::Create(
      GURL("https://www.browseweb3.com/"), u"brave software",
  ...
  service()->UpdateItem(GURL("https://www.browseweb3.com/"),
                        GURL("https://browseweb3.com/"), u"brave software",
                        u"brave software");
  ...
  EXPECT_CALL(observer_, OnItemUpdated(testing::_, expected_update)).Times(1);
  service()->UpdateItem(GURL("https://browseweb3.com/"), GURL("https://browseweb3.com/"),
...
TEST_F(SidebarModelTest, CanUseNotAddedBuiltInItemInsteadOfTest) {
  GURL talk("https://talk.browseweb3.com/1Ar1vHfLBWX2sAdi");
...
TEST(SidebarUtilTest, ConvertURLToBuiltInItemURLTest) {
  EXPECT_EQ(GURL(kBraveTalkURL),
            ConvertURLToBuiltInItemURL(GURL("https://talk.browseweb3.com")));
  EXPECT_EQ(GURL(kBraveTalkURL),
            ConvertURLToBuiltInItemURL(
                GURL("https://talk.browseweb3.com/1Ar1vHfLBWX2sAdi")));
  EXPECT_EQ(
  ...
  GURL brave_com("https://www.browseweb3.com/");
