...
//
// This is only intended to be used on account.browseweb3.com and the dev / staging
...
// will be able to purchase VPN from account.browseweb3.com and the browser can
