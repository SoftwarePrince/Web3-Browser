...
provideStrings({
  braveShields: 'BrowseWeb3 Shields',
  braveShieldsStandalone: 'Shields',
  braveShieldsEnable: 'Enable BrowseWeb3 Shields',
  braveShieldsUp: 'Shields are UP $1for$2',
  braveShieldsDown: 'Shields are DOWN $1for$2',
  braveShieldsBroken: 'If this site seems broken, try Shields down. $1Note: this may reduce BrowseWeb3\'s privacy protections.$2',
  braveShieldsBlockedNote: 'Trackers, ads, and more blocked $1Learn more$2',
  braveShieldsNOTBlockedNote: 'Not protected by BrowseWeb3 Shields $1Learn more$2',
  ...
  braveShieldsDownDesc: 'You are viewing this site without BrowseWeb3\'s privacy protection',
