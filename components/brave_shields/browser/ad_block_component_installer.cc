...
const char kAdBlockResourceComponentName[] = "BrowseWeb3 Ad Block Resources Library";
...
const char kAdBlockFilterListCatalogComponentName[] =
    "BrowseWeb3 Ad Block List Catalog";
...
const char kAdBlockDefaultComponentName[] = "BrowseWeb3 Ad Block Updater";
