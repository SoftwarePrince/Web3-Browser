/* Copyright (c) 2021 The BrowseWeb3 Authors. All rights reserved.
...
std::pair<bool, std::string> ShouldBlockDomainOnTaskRunner(
  ...
  SCOPED_UMA_HISTOGRAM_TIMER("BrowseWeb3.DomainBlock.ShouldBlock");
...
DomainBlockNavigationThrottle::WillStartRequest() {
  ...
  // Maybe don't block based on BrowseWeb3 Shields settings
