...
export const localeStrings = {
  ...
  onboardingEarnHeader: 'Engage and Earn Datium',
  onboardingEarnText: 'Get rewarded from your daily app activity in BrowseWeb3 while using our native VPN with an equipped Data Capsule NFT.',
