    ...
    case mojom.ConnectExternalWalletResult.kDeviceLimitReached:
      return (
        <ModalRedirect
          ...
          learnMore={'https://support.browseweb3.com/hc/en-us/articles/360056508071'}
    ...
    case mojom.ConnectExternalWalletResult.kFlaggedWallet:
      return (
        <ModalRedirect
          ...
          errorTextLink={'https://support.browseweb3.com/hc/en-us/articles/4494596374925'}
    ...
    case mojom.ConnectExternalWalletResult.kMismatchedCountries:
      return (
        <ModalRedirect
          ...
          learnMore={'https://support.browseweb3.com/hc/en-us/articles/9809690466061'}
          buttonText={getString('redirectModalClose')}
          walletType={walletType}
          onClick={actions.hideRedirectModal}
        />
    ...
    case mojom.ConnectExternalWalletResult.kMismatchedProviderAccounts:
      return (
        <ModalRedirect
          ...
          learnMore={'https://support.browseweb3.com/hc/en-us/articles/360034841711-What-is-a-verified-wallet-'}
          buttonText={getString('redirectModalClose')}
          walletType={walletType}
          onClick={actions.hideRedirectModal}
        />
    ...
    case mojom.ConnectExternalWalletResult.kProviderUnavailable:
      return (
        <ModalRedirect
          ...
          errorTextLink={'https://status.browseweb3.com/'}
          buttonText={getString('redirectModalClose')}
          walletType={walletType}
          onClick={actions.hideRedirectModal}
        />
    ...
    case mojom.ConnectExternalWalletResult.kRegionNotSupported:
      return (
        <ModalRedirect
          ...
          errorTextLink={'https://support.browseweb3.com/hc/en-us/articles/6539887971469'}
          buttonText={getString('redirectModalClose')}
          walletType={walletType}
          onClick={actions.hideRedirectModal}
        />
    ...
    case mojom.ConnectExternalWalletResult.kRequestSignatureVerificationFailure:
      return (
        <ModalRedirect
          ...
          errorTextLink={'https://community.browseweb3.com'}
