...
TEST(BraveQueryFilter, FilterQueryTrackers) {
  ...
  EXPECT_EQ(query_filter::MaybeApplyQueryStringFilter(
                GURL("https://browseweb3.com"), GURL("https://browseweb3.com"),
  ...
  EXPECT_EQ(query_filter::MaybeApplyQueryStringFilter(
                GURL(), GURL("https://browseweb3.com"),
  ...
  EXPECT_FALSE(query_filter::MaybeApplyQueryStringFilter(
      GURL("https://browseweb3.com"), GURL("https://browseweb3.com"), GURL(), "GET",
      false));
  ...
  EXPECT_FALSE(query_filter::MaybeApplyQueryStringFilter(
      GURL("https://browseweb3.com"), GURL("https://test.com"),
      GURL("https://test.com/?gclid=123"), "GET", false));
