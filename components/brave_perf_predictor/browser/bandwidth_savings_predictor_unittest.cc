...
TEST_F(BandwidthSavingsPredictorTest, FeaturiseResourceLoading) {
  ...
  const GURL main_frame("https://browseweb3.com/");

  auto fp_style = predictors::CreateResourceLoadInfo(
      "https://browseweb3.com/style.css",
...
TEST_F(BandwidthSavingsPredictorTest, PredictZeroInternalUrl) {
  const GURL main_frame("browseweb3://version");
  auto res = predictors::CreateResourceLoadInfo("browseweb3://version");
