...
inline constexpr char kManageUrlProd[] = "https://account.kahf.co/account/";
...
inline constexpr char kFeedbackUrl[] = "https://support.kahf.co/";
inline constexpr char kAboutUrl[] = "https://kahf.co/firewall-vpn/";
