...
TEST_F(SidebarServiceTest, UpdateItem) {
  ...
  const GURL brave_url("https://browseweb3.com/");
...
TEST_F(SidebarServiceTest, HideBuiltInItem) {
  ...
  }
  {
    ...
    dict.Set(sidebar::kSidebarItemURLKey, "https://custom1.browseweb3.com/");
...
TEST_F(SidebarServiceTest, MigratePrefSidebarBuiltInItemsSomeHidden) {
  ...
  {
    base::Value::Dict dict;
    dict.Set(sidebar::kSidebarItemURLKey, "https://anything.browseweb3.com/");
...
TEST_F(SidebarServiceTest, BuiltInItemUpdateTestWithBuiltInItemTypeKey) {
  ...
  {
    base::Value::Dict dict;
    dict.Set(sidebar::kSidebarItemURLKey, "https://deprecated.browseweb3.com/");
