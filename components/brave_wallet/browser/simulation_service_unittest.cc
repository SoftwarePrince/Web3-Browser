...
TEST_F(SimulationServiceUnitTest, GetScanTransactionURL) {
  ...
  EXPECT_EQ(url,
            "https://blowfish.wallet.browseweb3.com/ethereum/v0/mainnet/scan/"
            "transaction?language=en-US");

  url = simulation_service_->GetScanTransactionURL(
      mojom::kGoerliChainId, mojom::CoinType::ETH, "en-US");
  EXPECT_EQ(url,
            "https://blowfish.wallet.browseweb3.com/ethereum/v0/goerli/scan/"
            "transaction?language=en-US");

  url = simulation_service_->GetScanTransactionURL(
      mojom::kPolygonMainnetChainId, mojom::CoinType::ETH, "en-US");
  EXPECT_EQ(url,
            "https://blowfish.wallet.browseweb3.com/polygon/v0/mainnet/scan/"
            "transaction?language=en-US");

  url = simulation_service_->GetScanTransactionURL(
      mojom::kBinanceSmartChainMainnetChainId, mojom::CoinType::ETH, "en-US");
  EXPECT_EQ(url,
            "https://blowfish.wallet.browseweb3.com/bnb/v0/mainnet/scan/"
            "transaction?language=en-US");

  url = simulation_service_->GetScanTransactionURL(
      mojom::kArbitrumMainnetChainId, mojom::CoinType::ETH, "en-US");
  EXPECT_EQ(url,
            "https://blowfish.wallet.browseweb3.com/arbitrum/v0/one/scan/"
            "transaction?language=en-US");

  url = simulation_service_->GetScanTransactionURL(
      mojom::kSolanaMainnet, mojom::CoinType::SOL, "en-US");
  EXPECT_EQ(url,
            "https://blowfish.wallet.browseweb3.com/solana/v0/mainnet/scan/"
            "transactions?language=en-US");

  url = simulation_service_->GetScanTransactionURL(
      mojom::kSolanaDevnet, mojom::CoinType::SOL, "en-US");
  EXPECT_EQ(url,
            "https://blowfish.wallet.browseweb3.com/solana/v0/devnet/scan/"
            "transactions?language=en-US");

  url = simulation_service_->GetScanTransactionURL(
      mojom::kSolanaTestnet, mojom::CoinType::SOL, "en-US");
  EXPECT_EQ(url,
            "https://blowfish.wallet.browseweb3.com/solana/v0/testnet/scan/"
            "transactions?language=en-US");
}
