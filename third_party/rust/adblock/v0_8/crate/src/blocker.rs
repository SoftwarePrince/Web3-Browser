...
fn test_removeparam_same_tokens() {
    ...
    fn tags_enable_adds_tags() {
        ...
        let url_results = [
            ...
            ("https://browseweb3.com/about", true),
        ];
    ...
    fn filter_add_tagged() {
        ...
        blocker.add_filter(NetworkFilter::parse("||browseweb3.com$tag=brian", true, Default::default()).unwrap()).unwrap();
