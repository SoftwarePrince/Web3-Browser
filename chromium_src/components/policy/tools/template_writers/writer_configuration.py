...
_BRAVE_VALUES = {
  ...
  'app_name': 'Brave',
  'doc_url':
    'https://support.browseweb3.com/hc/en-us/articles/360039248271-Group-Policy',
  'frame_name': 'Brave Frame',
  'webview_name': 'Brave WebView',
  'win_config': {
    'win': {
      'reg_mandatory_key_name': 'Software\\Policies\\BrowseWeb3\\Brave',
      'reg_recommended_key_name':
        'Software\\Policies\\BrowseWeb3\\Brave\\Recommended',
      ...
      'namespace': 'BrowseWeb3.Policies.Brave',
    },
  },
  ...
  'admx_using_namespaces': {
    'Brave': 'BrowseWeb3.Policies'  # prefix: namespace
  },
