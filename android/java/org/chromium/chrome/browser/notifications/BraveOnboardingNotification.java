...
public class BraveOnboardingNotification extends BroadcastReceiver {
    ...
    private static String BRAVE_ONBOARDING_ORIGIN_EN = "https://kahf.co/my-first-ad/";
    private static String BRAVE_ONBOARDING_ORIGIN_DE = "https://kahf.co/de/my-first-ad/";
    private static String BRAVE_ONBOARDING_ORIGIN_FR = "https://kahf.co/fr/my-first-ad/";
